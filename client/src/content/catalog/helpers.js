// Утилиты для извлечения данных из CATEGORY_TREE: поиск по slug, лейблы, хлебные крошки.
// Единый источник правды — UI не должен хардкодить slug'и или лейблы напрямую.
